    ...
    case 0:
      return (
        <p>
          ...
          til StopSpillet på <a href="tel:70222825">70 22 28 25</a>.
        </p>
      );
    case 1:
      return (
        <p>
          ...
          kontakt til StopSpillet på <a href="tel:70222825">70 22 28 25</a>.
        </p>
      );
    case 2:
    case 3:
      return (
        <p>
          ...
          <a href="tel:70222825">70 22 28 25</a>, hvor vi kan hjælpe dig med
          afklaring og sammen finde ud af eventuelle videre tiltag.
        </p>
      );
    default:
      return (
        <React.Fragment>
          ...
          <p>
            <a href="tel:70222825">Kontakt os nu på 70 22 28 25</a>
          </p>
        </React.Fragment>
      );
  }
      ...
      {(context) => (
        <React.Fragment>
          <section className="quiz-content-header">
            <h3>Resultat</h3>
            {resultSelector(
              context.state.quiz.filter((val) => val === true).length,
            )}
          </section>

          <section className="quiz-content-footer">
            <button
              className="quiz-button quiz-button-reset"
              onClick={context.resetState}
            >
              Prøv igen!
            </button>
          </section>
